...
export default function Home() {
  const _about_me = `
I specialize in building robust and scalable Back-End services, 
with a strong focus on Banking and Financial Systems, alongside my backend expertise.`;
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="card text-bg-dark border-secondary mb-4">
                <div className="card-body p-md-4">
                  <h5 className="fw-bold mb-3">Contribute Projects</h5>
              ...
              <div className="card text-bg-dark border-secondary mb-4">
                <div className="card-body p-md-4">
                  <h5 className="fw-bold mb-3">tzhtet Github</h5>
                  <GitHubCalendar
                    username="tzhtet"
                    colorScheme="dark"
                    theme={{
                ...
                <div className="card-body p-md-4">
                  ...
                  <div className="mb-3">
                    <div className="hstack">
                      ...
                      <span className="text-muted ms-1">Intermediate</span>
                    </div>
                  </div>
                  ...
                  <div className="">
                    <div className="hstack">
                      ...
                      <span className="text-muted ms-1">Basic</span>
                    </div>
                  </div>
                </div>
              </div>
